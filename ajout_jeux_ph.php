...
<body>
<div class="container">
<form action="upload_ph.php" method="POST" enctype="multipart/form-data">

<h2> veuillez remplire les informations selon les informations du constructeur</h2>

     <form method="post" action="">
   <ul class="liste" ><li > 
        <label> verifiez si le jeux existe </label><br>
        <input list="options" id="options" name="options">
  <datalist id="options" >
  ...
  <?php
   ...
   $sql = "SELECT titre FROM titre WHERE '1'";
   ...
   <input type="checkbox" id="myCheckbox" name="myCheckbox" onclick="toggleText()">
   <p id="myText" style="display:none;"><label for="Titre" >Titre :</label><br>
  <input type="text"  id="Titre" name="Titre" ><br></p></li>
  <li>
...
<label>Introduisez la quantité disponible </label>
<input type="number" name="qte" min="1" required/><br>
