...
#charCount {
  font-size: 12px;
  color: #800000; /* rouge pour le compteur de caractères */
  margin-bottom: 10px;
}
...
<div class="container">
<form action="upload_accessoires.php" method="POST" class="form" id="form2" enctype="multipart/form-data">
<h2> veuillez remplire les informations selon les informations du constructeur</h2>

<ul class="liste" ><li > 
  

<label id="mess">mettez ici la description de votre article ou son etat :</label><br>
  <textarea name="description"  rows="4" cols="50" maxlength="300" required placeholder="description" style="border-radius:10px;"></textarea>
  <div id="charCount"></div>
   
    <label for="Name" >donnez le nom de votre article:</label><br>
  ...
  <option value="1">Categorie</option>
    <option value="2">Personalisation</option>
    <option value="3">Manettes</option>
    <option value="4">Casque audio </option>
    <option value="5">Console</option>
    <option value="6">Entretient</option>
  ...
  <select name="Platforme" id="Platforme" required>
  <option value="1">Platforme</option>
    <option value="2">Ordinateurs</option>
...
<label for="file">Image de l'article :</label><br>
